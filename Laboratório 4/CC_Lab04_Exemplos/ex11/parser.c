...
{
  "$end", "error", "$undefined", "NUMBER", "IF", "EQ", "LPAREN", "RPAREN",
  "ELSE", "'+'", "'-'", "'*'", "'/'", "NEG", "'^'", "'\\n'", "$accept",
...
{
       2,     6,     3,     3,    13,    14,    15,    16,    17,     4,
       4,     7,     8,     9,    10,    11,    11,    12,     9,    10,
       0,    11
};

static const yytype_int8 yycheck[] =
{
       0,     4,     3,     3,     7,     8,     9,    10,    11,    10,
      10,     9,    10,    11,    12,    14,    14,    15,    11,    12,
      -1,    14
};
...
{
       0,    17,     0,     3,    10,    18,    18,     9,    10,    11,
      12,    14,    15,    18,    18,    18,    18,    18
};
